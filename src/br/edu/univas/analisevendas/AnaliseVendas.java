...
public class AnaliseVendas {
	...
	public int AnaliseVendas(int[][] minhaMatriz) {
		dadosVendas = minhaMatriz;
	}
	
	public int calcularTotalVedasProduto(int produto) {
	...
	public int identidicarMesMaiorVendas() {
	...
	public int identificarProdutoMaisVendido() {
		...
		double maiorValor = Double.MIN_NORMAL;
